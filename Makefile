...
cppgvspc: cppgvspc.o gvspcSensor.o gvspcPix.o gvspcCsv.o gvspcV2PM.o gvspcLS.o
	$(CXX) $(LDFLAGS) $^ -o $@

cppgvspc_gen_p2vm: cppgvspc_gen_p2vm.o gvspcSensor.o gvspcPix.o gvspcCsv.o gvspcV2PM.o gvspcLS.o 
	$(CXX) $(LDFLAGS) $^ -o $@
